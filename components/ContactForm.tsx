...
export function ContactForm() {
  ...
  const initialSession = preset === "discovery" ? "Free discovery call — 20 minutes" : preset === "package" ? "10-session package interest" : preset === "mini" ? "Mini session — 45 minutes" : preset === "full" ? "Full session — 60 minutes" : "Not sure yet";
  ...
  return <form className="contact-form" onSubmit={submit} noValidate>
    ...
    <div className="form-grid">
      ...
      <label>Preferred session <span>*</span><select name="session" defaultValue={initialSession} required><option>Free discovery call — 20 minutes</option><option>Mini session — 45 minutes</option><option>Full session — 60 minutes</option><option>10-session package interest</option><option>Not sure yet</option></select></label>
